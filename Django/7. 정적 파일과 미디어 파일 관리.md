...
- 3일차에 부트스트랩 연습할 때 만들었던 blog_list.html은 다음과 같다.
...
<html>
    <head>
        ...
        <script src="https://kit.fontawesome.com/f6a01db939.js" crossorigin="anonymous"></script>
    </head>
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container">
              <a class="navbar-brand" href="./index.html">JaeIk Lee</a>
        ...
        <footer class="py-5 bg-dark">
            <div class="container">
                <p class="m-0 text-center text-white">Copyright &copy; Do It Django A to Z 2021</p></div>
        </footer>
